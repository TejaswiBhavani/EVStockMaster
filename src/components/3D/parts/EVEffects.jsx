    ...
    <group name="ev-effects">
      ...
      {isCharging && (
        <group position={[-1.2, 0.15, 0.6]}>
          ...
          <Sphere ref={chargingRef} args={[0.05, 16, 16]} position={[0.15, 0, 0]}>
      ...
      {engineRunning && (
        <group>
          {/* Motor heat effect */}
          <Sphere ref={engineRef} args={[0.3, 16, 16]} position={[0.8, -0.25, 0]}>
            <meshStandardMaterial
              color="#06d6a0"
              emissive="#06d6a0"
          ...
          <Sphere args={[0.3, 16, 16]} position={[-0.8, -0.25, 0]}>
            <meshStandardMaterial
              color="#06d6a0"
              emissive="#06d6a0"
              emissiveIntensity={0.3}
      ...
      <RoundedBox position={[0, -0.5, 0]} args={[0.1, 0.02, 0.05]} radius={0.01}>
        <meshStandardMaterial
      ...
      {engineRunning && (
        <group>
          ...
          <RoundedBox position={[0.4, -0.4, 0]} args={[0.8, 0.01, 0.02]} radius={0.005}>
      ...
      <group position={[0, 0.8, 0]}>
        {/* System Status */}
        <Sphere args={[0.02, 8, 8]} position={[-0.1, 0, 0]}>
        ...
        {selectedPart && (
          <Sphere args={[0.02, 8, 8]} position={[0.2, 0, 0]}>
