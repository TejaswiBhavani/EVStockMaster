        ...
        >
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-gradient-to-br from-dark-900 to-dark-800 text-gray-300">
                  ...
                  <div>
                    ...
                    {showDomainHelp && (
                      <div className="mt-2 pt-2 border-t border-red-400/20">
                        ...
                        <div className="text-xs text-red-300 mb-2">
                          Current domain:{' '}
                          <code className="bg-red-900/30 px-1 py-0.5 rounded">
                            {domainUtils.getCurrentDomainInfo().origin}
                          </code>
                        </div>
                        <button
                          type="button"
                          onClick={() =>
                            window.open(domainUtils.getFirebaseConsoleAuthURL(), '_blank')
                          }
