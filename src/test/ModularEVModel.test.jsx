...
vi.mock('../components/3D/parts/EVChassis', () => ({
  default: ({ selectedPart, onPartClick }) => (
    <div data-testid="ev-chassis" data-selected={selectedPart} onClick={() => onPartClick?.('body')}>
...
vi.mock('../components/3D/parts/EVPowertrain', () => ({
  default: ({ selectedPart, onPartClick }) => (
    <div data-testid="ev-powertrain" data-selected={selectedPart} onClick={() => onPartClick?.('battery')}>
...
vi.mock('../components/3D/parts/EVExterior', () => ({
  default: ({ selectedPart, onPartClick }) => (
    <div data-testid="ev-exterior" data-selected={selectedPart} onClick={() => onPartClick?.('charging-port')}>
...
vi.mock('../components/3D/parts/EVInterior', () => ({
  default: ({ selectedPart, onPartClick }) => (
    <div data-testid="ev-interior" data-selected={selectedPart} onClick={() => onPartClick?.('dashboard')}>
